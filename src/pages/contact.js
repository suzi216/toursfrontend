                            ...
                            >
                                <div className="grid md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 outline-none transition-all duration-300"
                                ...
                                <div className="mb-6">
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        required
                                        className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 outline-none transition-all duration-300 resize-none"
                                ...
                                >
                                    {isSubmitting ? (
                                        ...
                                        <>
                                            <GiPaperPlane className="w-5 h-5" />
                                            Send Message
                                        </>
                                    )}
                                </button>
